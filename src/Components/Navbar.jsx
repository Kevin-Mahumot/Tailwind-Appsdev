  ...
  return (
    <div className='navbar flex justify-between items-center text-1xl text-center h-24 max-w-[1080px] px-4 text-white'>
      ...
      <ul className='hidden md:flex items-center font-medium'>
        ...
        <li className='p-4 pb-6 md:pt-0 hover:border-b-2 border-red-600'>MANAGE <br />HOUSEHOLD</li>
      ...
      {/* Mobile Menu */}
      {nav && (
        <div className={`fixed left-0 top-0 w-[60%] h-full bg-black/80 backdrop-filter backdrop-blur-md ease-in-out duration-1000`}>
          <h2 className='text-3xl font-bold m-4 text-white pt-3'>
            BI<span className='text-red-600 font-bold'>U</span>MS
          </h2>

          <ul className='uppercase p-4'>
            <li className='p-4 hover:text-red-600 hover:bg-gray-200 hover:rounded-md transition duration-100'>Home</li>
            <li className='p-4 hover:text-red-600 hover:bg-gray-200 hover:rounded-md transition duration-100'>About</li>
            <li className='p-4 hover:text-red-600 hover:bg-gray-200 hover:rounded-md transition duration-100'>Events</li>
            <li className='p-4 md:pl-4 hover:text-red-600 hover:bg-gray-200 hover:rounded-md transition duration-100'>Manage Household</li>
            <li className='p-4 hover:text-red-600 hover:bg-gray-200 hover:rounded-md transition duration-100'>Contacts</li>
            <li className='p-4 hover:text-red-600 hover:bg-gray-200 hover:rounded-md transition duration-100'>Feedback</li>
          </ul>
        </div>
      )}
    </div>
